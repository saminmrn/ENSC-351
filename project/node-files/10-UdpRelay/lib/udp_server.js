...
function handleCommand(socket) {
	...
	handleUDPConnection(socket, "hr_monitor", "heartRate_monitor_reply");
	handleUDPConnection(socket, "calories_monitor", "calories_monitor_reply");
	handleUDPConnection(socket, "steps_monitor", "steps_monitor_reply");
	handleUDPConnection(socket, "distance_monitor", "distance_monitor_reply");
};