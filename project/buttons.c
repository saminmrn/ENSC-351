...
static int current_mode_grey = 0;
...
int get_mode_grey()
{
    if (current_mode_grey % 2 == 0)
    {
        return 0;
    }
    if (current_mode_grey % 2 == 1)
    {
        return 1;
    }
    // if (current_mode_grey % 4 == 2)
    // {
    //     return 2;
    // }
    // if (current_mode_grey % 4 == 3)
    // {
    //     return 3;
    // }
